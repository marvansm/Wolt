  ...
  const mockOrders = [
    {
      ...
      items: [
        { name: "Hamburger", price: 3.1, qty: 2, total: 6.2 },
        {
    ...
    {
      id: 2,
      name: "Wolt Market Binagadi",
      date: "05/02/2026, 01:10",
      price: "AZN33.78",
    },
    {
      id: 3,
      name: "Beef Tantuni Azadliq",
      date: "08/01/2026, 00:36",
      price: "AZN16.15",
    },
    {
      id: 4,
      name: "McDonald's & McCafe Nasimi",
      date: "25/11/2025, 15:21",
      price: "AZN48.09",
    },
    {
      id: 5,
      name: "Bibari Cig Köfte 8 Noyabr",
      date: "13/07/2025, 03:22",
      price: "AZN9.84",
    },
    {
      id: 6,
      name: "Bibari Cig Köfte 8 Noyabr",
      date: "13/07/2025, 03:20",
      price: "--",
    },
    {
      id: 7,
      name: "Aloe Aptek Vorovski",
      date: "10/07/2025, 13:16",
      price: "AZN12.07",
    },
    {
      id: 8,
      name: "Aloe Aptek Vorovski",
      date: "10/07/2025, 13:15",
      price: "--",
    },
  ];
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  <div className="flex items-center gap-2 text-gray-400 text-sm">
                    ...
                    <span className="bg-white/10 px-3 py-1 rounded-lg text-white font-bold text-xs uppercase">
                      Delivery
                    </span>
                    <span className="bg-green-500 px-3 py-1 rounded-lg text-white font-bold text-xs uppercase">
                      Delivered
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex justify-between items-center text-gray-400">
                <span className="text-sm font-bold">
                  Delivery {selectedOrder.deliveryTo}
                </span>
              ...
              <div className="flex justify-between items-center text-gray-400 pt-2 border-t border-white/5">
                ...
                <span className="font-medium">
                  {selectedOrder.costs?.serviceFee?.toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between items-center text-gray-400 pt-2 border-t border-white/5">
                <span className="text-sm font-bold">Add courier tip</span>
                <span className="font-medium">
                  {selectedOrder.costs?.tip?.toFixed(2)}
                </span>
              </div>
              ...
              <div className="flex items-start gap-8">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="flex gap-4">
                    <button className="text-[#009de0] font-bold text-sm hover:underline">
                      Edit
                    </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-[#1a1a1b] p-8 rounded-[24px] border border-white/5">
                  ...
                  <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                    You can use gift cards to pay for your orders.
                  </p>
                  <div className="flex gap-4">
          ...
          <div className="space-y-8">
              ...
              {mockOrders.map((order) => (
                ...
                >
                  <div className="flex items-center gap-8 flex-1">
                    <h3 className="text-[17px] font-bold text-white min-w-[280px]">
                      {order.name}
                    </h3>
            ...
            <div className="flex flex-col items-center gap-6 pt-8">
              <p className="text-gray-400 text-[15px]">
                Good news, everything's up to date 🥳
              </p>
