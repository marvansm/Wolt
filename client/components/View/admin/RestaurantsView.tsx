...
export default function RestaurantsPageView() {
  ...
  const createMutation = useMutation({
    mutationFn: (newRestaurant: any) =>
      api.PostData("/restaurants", newRestaurant),
    onSuccess: () => {
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-[#a3a3a3]">
            Manage partnered restaurants and their profiles.
          </p>
        </div>
        <button
                      ...
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-lg bg-[#1f1f1f] flex items-center justify-center overflow-hidden border border-[#2b2b2b]">
                          {restaurant.avatar || restaurant.image ? (
                            <img
                              src={restaurant.avatar || restaurant.image}
                              alt={restaurant.name}
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[#737373] text-xs truncate max-w-[200px]">
                ...
                <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 no-scrollbar">
                  {formData.menu.length === 0 ? (
                    <div className="text-center py-8 border-2 border-dashed border-[#1f1f1f] rounded-xl">
                      <Package
                        size={32}
                        className="mx-auto text-[#2b2b2b] mb-2"
                      />
                    ...
                    formData.menu.map((item: any, index: number) => (
                      <div
                        key={index}
                        className="p-4 bg-[#141414] border border-[#1f1f1f] rounded-xl space-y-3 relative group/item"
                      >
                        <button
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          ...
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              value={item.weight || ""}
                              onChange={(e) =>
                                updateMenuItem(index, "weight", e.target.value)
                              }
                              className="w-full bg-[#0a0a0a] border border-[#1f1f1f] rounded-lg px-3 py-2 text-sm"
                            />
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                updateMenuItem(index, "badge", e.target.value)
                              }
                              className="w-full bg-[#0a0a0a] border border-[#1f1f1f] rounded-lg px-3 py-2 text-sm"
                            />
                          </div>
