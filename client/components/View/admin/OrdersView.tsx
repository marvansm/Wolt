...
const initialOrders = [
  {
    id: "#ORD-7421",
    customer: "John Doe",
    items: ["Pepperoni Pizza x1", "Coca-Cola x2"],
    total: "24.50",
    status: "delivered",
    createdAt: "2024-03-20 14:32",
  },
  {
    id: "#ORD-7420",
    customer: "Jane Smith",
    items: ["Chicken Doner x2", "Ayran x2"],
    total: "42.00",
    status: "preparing",
  ...
  },
  {
    ...
    items: ["Lentil Soup x1", "Cheeseburger x1"],
    total: "35.20",
    status: "delivered",
    createdAt: "2024-03-20 12:20",
  },
];
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-[#a3a3a3]">
          Monitor and update active customer orders.
        </p>
      </div>
        ...
        <div className="p-4 border-b border-[#1f1f1f] bg-[#141414]/50 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {["all", "pending", "preparing", "delivered"].map((f) => (
              <button
                key={f}
                className="px-3 py-1.5 rounded-lg text-xs font-bold uppercase bg-[#1f1f1f] text-[#a3a3a3] hover:text-white transition-colors"
              >
                {f}
              </button>
            ))}
              ...
              {["pending", "preparing", "delivered", "cancelled"].map(
                (status) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl font-bold uppercase tracking-wider text-xs flex items-center justify-between border transition-all ${
