      ...
      <div className="grid grid-cols-2 gap-[32px]">
        <Reveal direction="left" delay={0.2} className="w-full">
          <ImageCard
            ...
            description="Our world-class support team has your back, with friendly assistance and fast response times."
          >
        ...
        <Reveal direction="right" delay={0.3} className="w-full">
          <ImageCard
            ...
            alt="wolt+"
            title="0₼ delivery fees with Wolt+"
            description="Enjoy zero delivery fees from the best restaurants and stores in your city."
            bottomElement={
